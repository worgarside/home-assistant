...
<details><summary><strong>MtrxPi LED Matrix</strong></summary>

**Entity ID: `light.mtrxpi_led_matrix`**

File: [`light/mtrxpi_led_matrix.yaml`](entities/light/mtrxpi_led_matrix.yaml)
</details>
